...
export default function InvMain() {
    ...
    return (
        <div className='acc-group'>
            <div className='acc-title'>Investments</div>
                    ...
                    return (
                        <div className='acc-item' key={index}>
                            <div className='acc-body' onClick={() => clickEdit(field)}>
                                ...
                                <div className='acc-field' >{field.qty}</div>
                                <div className='acc-field' >{field.balance}</div>
                                <div className='acc-field' >{field.current_value}</div>
                                <div className='acc-field' >{field.deductions}</div>
                            </div>
